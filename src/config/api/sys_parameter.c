...
volatile const EEPROM_BMS_t eepBmsDef = {
 ...
 /***BMS Parameter Setting***/
  ...
  /*Limit,Release,LimitTime,ReleaseTime*/
    {842000, 830000, 3000, 3000}, // OVP
    {824000, 803000, 3000, 3000}, // OVW
    {568000, 580000, 3000, 3000}, // UVP
    {588000, 608000, 3000, 3000}, // UVW
    {   400,    100, 2000, 5000}, // CellUBP
    {   350,    200, 2000, 5000}, // CellUBW
    {  4200,   4180, 2000, 5000}, // CellOVP
    {  3100,   3300, 2000, 5000}, // CellUVP

  /**OverCurrent**/
  /*Limit,Release,LimitTime,ReleaseTime*/
    {-96000,  -1000, 1000, 1000}, // ODCP
    {-91000,  -1000, 1000, 1000}, // ODCW
    { 96000,   1000, 1000, 1000}, // OCCP
    { 91000,   1000, 1000, 1000}, // OCCW
 ...
 /***BMS Capacity Record***/
    (CELL_DESIGN_CAP), // mAH,Batt FullCap
